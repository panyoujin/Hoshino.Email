...
namespace Hoshino.Email.Repository
{
    public class EmailInBoxRepository
    {
        ...
        public bool Insert(EmailInBoxEntity model)
        {
            ...
            if(model.EmailInboxDate != null && model.EmailInboxDate.HasValue)
            {
            ...
            if(model.EmailInboxState != null && model.EmailInboxState.HasValue)
            {
                dic["EmailInboxState"] = model.EmailInboxState;
            }
            if(model.EmailInboxIsDel != null && model.EmailInboxIsDel.HasValue)
            {
